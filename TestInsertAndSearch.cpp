...
Assignment #4  TestInsertAndSearch.cpp
               ...
               Then it searches for every key from a search file.
...
int main(int argc, char** argv){
	...
	cout << "The minimum element is " << my_mpq.findMin() << endl;

	while (searchfile >> value) {
		if (my_mpq.find(value)) {
